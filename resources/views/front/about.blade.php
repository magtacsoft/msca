                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        </p><p>Respublika Prezidentinin apardığı məqsədyönlü siyasət nəticəsində yaradılan sağlam mühit digər sahələrdə olduğu kimi özəl sektorun da sürətli inkişafına təkan vermişdir: Bu baxımdan "Modern Style Construction Agro" MMC müvafiq lisenziya və icazələri alaraq qüvvədə olan qanunvericiliyə uyğun olaraq. "Modern Style Construction Agro" MMC olaraq, qabaqcıl və müasir texnologiyaları tətbiq edərək, yeni istehsal sahələri yaratmağa və etibarlı tərəfdaş kimi tanınmağa çalışırıq. Məqsədlərimizə tam və effektiv şəkildə nail olmaq üçün keyfiyyətə, sağlamlığa, təhlükəsizliyə və ətraf mühitin qorunmasına böyük önəm veririk.</p><p><br></p><p>&nbsp;<strong><em>İdarə Heyətinin sədri: Anar E.Musayev</em></strong></p>
                                        <p></p>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="wprt-galleries galleries w-570px" data-width="135" data-margin="10">
                                            <div id="" class="flexslider">
                                                <ul class="slides">
                                                    <li class="flex-active-slide">
                                                        <a class="zoom" href="http://msca.az/storage/161/mscalogo5oktyabrinfo.png"><i class="fa fa-arrows-alt"></i></a>
                                                        <img src="http://msca.az/storage/161/mscalogo5oktyabrinfo.png" alt="image">
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <div id="wprt-carousel" class="flexslider">
                                                ...
                                                <div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="index-logo slides" style="width: 200%; transition-duration: 0s; transform: translate3d(0px, 0px, 0px);">
                                                        <li class="indexLogo flex-active-slide" style="width: 135px; margin-right: 10px; float: left; display: block;"><img src="http://msca.az/storage/161/mscalogo5oktyabrinfo.png" alt="image" draggable="false"></li>
